...
public class SearchSessionImpl implements SearchSession, ApplicationContextAware {
  ...
  private Hashtable all_active_searchable_objects = new Hashtable();
  ...
  private SearchSessionImpl() {
    log.info("new SearchSessionImpl("+(++inst_count)+")");
  }
  ...
  public SearchSessionImpl(ProfileService profile_service,
    ...
    log.debug("New SearchSessionImpl : "+this.hashCode());
  }
  ...
  public TransformingIRResultSet search(LandscapeSpecification landscape, 
    ...
    try {
      ...
      Hashtable queries_by_repository = new Hashtable();
      ...
      for ( Enumeration rep_ids = queries_by_repository.keys(); rep_ids.hasMoreElements(); ) {
        // This will yield strings like "LC:bath"
        String repos = (String) rep_ids.nextElement();
